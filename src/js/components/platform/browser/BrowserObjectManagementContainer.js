...
import BrowserObjectTable from '../browser/BrowserObjectTable';


class BrowserObjectManagementContainer extends React.Component{
...
export default BrowserObjectManagementContainer
