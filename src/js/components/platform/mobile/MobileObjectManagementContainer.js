...
import MobileObjectTable from '../mobile/MobileObjectTable';


class MobileObjectManagementContainer extends React.Component{
...
export default MobileObjectManagementContainer
