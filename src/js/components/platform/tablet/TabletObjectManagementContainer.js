...
import TabletObjectTable from '../tablet/TabletObjectTable';


class TabletObjectManagementContainer extends React.Component{
...
export default TabletObjectManagementContainer
